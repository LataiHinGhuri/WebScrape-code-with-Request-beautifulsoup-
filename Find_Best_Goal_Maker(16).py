...
player={'name':{'goal':0,'asist':0,'total':0, 'team':'tname', 'source':'website'}}
ListOfplayer=[]

writeList=[]
writeList.append(['Name','Goal','Asist','Total Point', 'Currently Playing', 'Source'])
make_file('Best_Goal_Maker.csv','w',writeList)
#get url 
#http://www.espnfc.co.uk/club/barcelona/83/squad?league=all
#http://www.espnfc.co.uk/club/real-madrid/86/squad?league=all
#"http://www.espnfc.us/team/paris-saint-germain-/160/squad?league=all"
...
while i<NoPlayer:
	...
	v4=player[p]['team']
	v5=player[p]['source']
	writeList.append([p,v1,v2,v3,v4,v5])
